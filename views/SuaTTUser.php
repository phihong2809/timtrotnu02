    ...
    <header class="header">
        <div class="grid header__1">
            <div class="header__logo">
                ...
                <h3 class="header__span">Sua thong tin tai khoan</h3>
            </div>
                ...
                <form action="?task=update_usert" method="POST" enctype="multipart/form-data">
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" value = "<?php echo $data['id_user']?>" class="auth-form__input"  name = "id_user" placeholder="So Dien Thoai ">
                        </div>
                        <div class="auth-form__group">
                        ...
                        <div class="auth-form__group">
                            <input type="file" class="auth-form__input"  name = "photo" placeholder="anh "><img src="<?php echo $data['photo']?>" alt="">
                        </div>
                    </div>
